 ...
 * Description: This plugin will load necessary core for Ale Theme like: Custom Post Types, Custom Taxonomies, Custom Metaboxes, Custom Widgets etc.
 * Version: 1.0
 * Author: CRIK0VA
...
function ale_init_widgets() {
	register_widget('Ale_Blog_Widget');
}
...
add_action('init', 'alekids_contact_form');
function alekids_contact_form()
{
