...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__('No Repeat', 'alekids'),
		'repeat-x'  => esc_html__('Repeat Horizontally', 'alekids'),
		'repeat-y'  => esc_html__('Repeat Vertically', 'alekids'),
		'repeat'    => esc_html__('Repeat All', 'alekids'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__('Top Left', 'alekids'),
		'top center'    => esc_html__('Top Center', 'alekids'),
		'top right'     => esc_html__('Top Right', 'alekids'),
		'center left'   => esc_html__('Middle Left', 'alekids'),
		'center center' => esc_html__('Middle Center', 'alekids'),
		'center right'  => esc_html__('Middle Right', 'alekids'),
		'bottom left'   => esc_html__('Bottom Left', 'alekids'),
		'bottom center' => esc_html__('Bottom Center', 'alekids'),
		'bottom right'  => esc_html__('Bottom Right', 'alekids')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__('Scroll Normally', 'alekids'),
		'fixed'  => esc_html__('Fixed in Place', 'alekids')
		);
...
function of_recognized_background_size() {
	$default = array(
		'auto' => esc_html__('Auto', 'alekids'),
		'cover'  => esc_html__('Cover', 'alekids'),
		'contain'  => esc_html__('Contain', 'alekids'),
		'initial'  => esc_html__('Initial', 'alekids'),
...
function of_recognized_menu_text_align() {
	$default = array(
		'left' => esc_html__('Left', 'alekids'),
		'center'  => esc_html__('Center', 'alekids'),
		'right'  => esc_html__('Right', 'alekids'),
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__('Normal', 'alekids'),
		'italic'      => esc_html__('Italic', 'alekids'),
		'bold'        => esc_html__('Bold', 'alekids'),
		'bold italic' => esc_html__('Bold Italic', 'alekids')
		);
...
function of_recognized_font_transform() {
	$default = array(
		'none'      => esc_html__('None', 'alekids'),
		'capitalize'      => esc_html__('Capitalize', 'alekids'),
		'uppercase'        => esc_html__('Uppercase', 'alekids'),
		'lowercase' => esc_html__('Lowercase', 'alekids')
	);
	return apply_filters( 'of_recognized_font_styles', $default );
}
...
function of_recognized_font_weight() {
	$default = array(
		'200' => esc_html__('Extra-Light 200', 'alekids'),
		'300' => esc_html__('Light 300', 'alekids'),
		'400' => esc_html__('Regular 400', 'alekids'),
		'500' => esc_html__('Medium 500', 'alekids'),
		'600' => esc_html__('Semi-Bold 600', 'alekids'),
		'700' => esc_html__('Bold 700', 'alekids'),
		'800' => esc_html__('Extra-Bold 800', 'alekids'),
		'900' => esc_html__('Ultra-bold 900', 'alekids')
	);
